        ...
        <div class="card shadow bg-dark text-white" style="width: 25rem;">
            <div class="card-body">
                ...
                <form action="#" method="POST">
                    ...
                    Mot de passe : <input class="input-group input-group-sm mb-3" type="text" name="motdepasse" value="<?= $oneUser["user_password"] ?>">
                    <label for="motdepasse" class="form-label"></label><span class="text-danger">
                        <?=
