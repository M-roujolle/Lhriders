...
<body>
    <a class="btn btn-danger mt-2 ms-2" href="home.php"><i class="bi bi-arrow-return-left"></i> Retour à l'accueil</a>
                    ...
                    <div class="navColor text-white d-flex justify-content-center">
                        <form action="contact.php" method="POST" class="ps-3 pe-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="<?= isset($_POST["pseudo"]) ? htmlspecialchars($_POST["pseudo"]) : "" ?>" name="pseudo" type="text" class="form-control w-75" id="pseudo" placeholder="Ex : Jean414...">
                                ...
                                <input value="<?= isset($_POST["motdepasse"]) ? htmlspecialchars($_POST["motdepasse"]) : "" ?>" name=" motdepasse" type="mail" class="form-control w-75" id="motdepasse" placeholder="Ex : ******">
