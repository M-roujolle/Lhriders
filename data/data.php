...
$vidConsEnt = [
    ...
    [
        "id" => 2,
        "iframe" => '<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/SXwg59iA3jA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Le kit chaîne",
        "description" => "Tuto mécanique : Changer son kit chaîne",
    ],
    [
        "id" => 3,
    ...
    [
        "id" => 4,
        "iframe" => '<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/jAhAef6p2lQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "L'éclairage",
        "description" => "Tuto mécanique : Améliorer son éclairage",
    ],
