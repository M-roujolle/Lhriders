...
$showYourBike = [
    [
        "id" => 1,
        "pictures" => "./assets/img/speedtriple.jpeg",
        "model" => "Speed Triple - 2020",

    ],
    [
        "id" => 2,
        "pictures" => "./assets/img/s1000rr.jpeg",
        "model" => "S1000RR - 2019",
    ],
    [
        "id" => 3,
        "pictures" => "./assets/img/royalenfield.jpeg",
        "model" => "Royal Enfield - 1998",

    ],
    [
        "id" => 4,
        "pictures" => "./assets/img/custom.jpeg",
        "model" => "Custom - 2002",
    ],
    [
        "id" => 5,
        "pictures" => "./assets/img/custom1.jpeg",
        "model" => "Custom base bmw - 2008",
    ],
    [
        "id" => 6,
...
$legis = [
    [
        "id" => 1,
        "pictures" => "./assets/img/icone1.png",
        "name" => "Réglementation et déclaration des sorties moto en groupe",
        "description" => "Rouler à moto, scooter quad, roadster, trail ou custom de grosses cylindrées en groupe est soumis à certaines réglementations, de la Code de la route et administratives. La loi impose que tout rassemblement de motards nécessite une déclaration en préfecture du moment qu’elle comporte la participation de véhicules terrestres à moteur et qu’elle se déroule sur la voie publique. Le respect de ces réglementations est indispensable sous peine de sanctions.",

    ],
    [
        "id" => 2,
        "pictures" => "./assets/img/icone2.png",
        "name" => "Pourquoi déclarer une balade moto en groupe ?",
        "description" => "La personne physique ou l’association qui invite des motards à une rando moto avec road book est considérée comme l’organisateur. Ainsi, ses responsabilités sont engagées en cas de problème ou d’accident pendant les virées sur petites routes, routes sinueuses, routes départementales. Pour éviter les sanctions et autres conséquences que pourrait entraîner des balades en groupe non réglementées, le mieux est de toujours déclarer ce type de rassemblement.
    ...
    [
        "id" => 3,
        "pictures" => "./assets/img/icone3.png",
        "name" => "L’organisateur du rassemblement de moto est responsable",
        "description" => "L’organisateur doit être capable de reconnaître qu’un tel ou tel nombre de participants pourrait gêner la circulation. De ce fait, il convient de scinder les participants en plusieurs groupes de 5 à 7 motards ou motardes. La déclaration en préfecture est obligatoire pour un tel rassemblement même si le nombre de participants n’excède pas les 50 motos.
    ...
    [
        "id" => 4,
        "pictures" => "./assets/img/icone4.png",
        "name" => "Obligation de déclaration selon le nombre de participants",
        "description" => "Un arrêt du 7 mai 2008 du Conseil d’État précise que la déclaration n’est pas systématiquement obligatoire. Cette obligation de déclaration ne s’impose que si le rassemblement pouvait avoir une incidence sur les conditions de circulation et sur la sécurité des autres usagers des voies publiques ouvertes à la circulation. Toutefois, il est précisé par l’instruction interministérielle (INTA1801862J) de 2018 que les balades de moins de 50 participants ne nécessitent pas de déclaration en préfecture.",
    ],
    [
        "id" => 5,
        "pictures" => "./assets/img/icone5.png",
        "name" => "Où et comment déclarer une balade moto organisée ?",
        "description" => "Rappelons que le décret 2006-554 du 16 mai 2006 impose aux organisateurs de balades de véhicules motorisés à respecter la réglementation sur la tenue de ce genre de rassemblement. La déclaration est obligatoire pour 400 véhicules à moteur de deux à quatre roues. Au-delà, une autorisation est requise.
    ...
    [
        "id" => 6,
        "pictures" => "./assets/img/icone6.png",
        "name" => "À qui adresser la déclaration ?",
        "description" => "La déclaration des concentrations de véhicules terrestres à moteur et des roadtrip est à adresser au préfet de département. Si les voyages à moto se déroulent dans plusieurs départements, il faut adresser la déclaration aux préfets de chacun des départements traversés. Si la concentration concerne plus de vingt départements, une déclaration auprès du ministre de l’Intérieur est obligatoire.",
    ],
    [
        "id" => 7,
        "pictures" => "./assets/img/icone7.png",
        "name" => "Procédures de déclaration d’un rassemblement de motards",
        "description" => "La déclaration de la concentration doit être formulée 2 mois avant la sortie. Ce délai d’envoi est porté à 3 mois lorsque le nombre de départements parcouru est supérieur ou égal à vingt. 3 exemplaires de ce formulaire sont à envoyer à tous les préfectures concernées.",
    ],
    [
        "id" => 8,
        "pictures" => "./assets/img/icone8.png",
        "name" => "Sanctions pour l’organisateur en cas de non-déclaration",
        "description" => "L’organisation de manifestation de véhicules terrestres à moteur sur les voies publiques sans avoir procédé à la déclaration ou obtenu une autorisation administrative est soumise à des peines prévues à l’Article L411-7 du Code de la route. L’organisateur est sanctionné de contraventions de classe 5 (amende jusqu’à 1 500€, suspension de permis…) en cas de :
            <li>Non-respect des formalités de déclaration d’un voyage moto en groupe
            <li>Non-respect ou non-application des prescriptions figurant dans l’autorisation administrative délivrée",
    ],
];
...
$vidConsEnt = [
    [
        "id" => 1,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/JUnt9_nikjM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Maitrise",
        "description" => "Maitriser sa moto sur route partie 1",

    ],
    [
        "id" => 2,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/sxpk2KV32ic" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Maitrise",
        "description" => "Maitriser sa moto sur route partie 2",
    ],
    [
        "id" => 3,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/SXwg59iA3jA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Entretien",
        "description" => "Tuto mécanique: Changer son kit chaine",

    ],
    [
        "id" => 4,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/ai74i8yCGQQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Entretien",
        "description" => "Tuto mécanique : Changer son embrayage",
    ],
    [
        "id" => 5,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/AYdaDcOIcVs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Entretien",
    ...
    [
        "id" => 7,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/yHlI4IMDHrE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Entretien",
        "description" => "Etat des lieux et entretien moteur",
    ],
    [
        "id" => 8,
        "iframe" => '<iframe class="responsive-iframe" width="560" height="315" src="https://www.youtube.com/embed/CDnXD6ph7TA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        "name" => "Entretien",
        "description" => "Entretien partie cycle",
    ],
];
